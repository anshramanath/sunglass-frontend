const BRANDS = {
  "prosport-sunglasses": {
    ...
    announcements: [
      ...
      "No Hidden Taxes. Ever.",
      "Built for Athletes, Made to Last",
  ...
  "bikershades": {
    ...
    announcements: [
      "Shipping Included in the Price",
      "Built for Riders, Trusted on the Road",
      "Try Before You Buy — Risk-Free",
      "No Hidden Taxes. Ever.",
      "Rider-First Eyewear Since Day One",
  ...
  "sunglass-monster": {
    ...
    announcements: [
      "Shipping Included in the Price",
      "Bold Style for the Unapologetic",
      "Fashion-Forward Frames for Every Face",
      "No Hidden Taxes. Ever.",
      "Make Every Look a Statement",
      "Hundreds of Styles to Choose From",
