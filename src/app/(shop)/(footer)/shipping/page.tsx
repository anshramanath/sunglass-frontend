      ...
      <div className="mx-auto max-w-[640px]">
        ...
        <div className="mt-12 space-y-9">
          ...
          <section>
            ...
            <p className="text-[15px] text-grey-600 leading-relaxed mt-3">Shipping and tax are included in the price of every order. Orders are processed within 1–3 business days.</p>
          </section>

          <section className="border-t border-grey-200 pt-9">
            <h2 className="text-[21px] font-normal">Delivery</h2>
            <p className="text-[15px] text-grey-600 leading-relaxed mt-3">You enter your shipping address during Stripe checkout. Delivery typically takes 2–5 business days depending on your location. Orders ship from Dallas, TX. We currently only ship within the United States.</p>
          </section>
