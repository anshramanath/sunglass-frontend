  ...
  return (
    <main className="flex-1 px-5 py-16 lg:py-24">
      <div className="mx-auto max-w-[620px]">
        ...
        <h1 className="text-[34px] lg:text-[56px] font-normal tracking-[-0.01em] text-center mt-3 leading-tight">Great sunglasses shouldn&apos;t cost a fortune.</h1>
        ...
        <div className="mt-12 space-y-6 text-[18px] text-grey-700 leading-relaxed">
          ...
          <p className="text-ink">Cool sunglasses. Fair prices. That&apos;s the whole thing.</p>
        </div>
      </div>
    </main>
  );
