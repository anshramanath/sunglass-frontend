...
export default function CheckoutPageClient({ brandLogo, brandName }: { brandLogo: string; brandName: string }) {
        ...
        <div className="mx-auto max-w-[1200px] px-5 lg:px-10">
          <div className="h-16 flex items-center justify-between relative">
            <Link href="/" className="shrink-0" aria-label={`${brandName} home`}>
              <Image src={brandLogo} alt={brandName} width={120} height={28} className="h-8 w-auto" />
            </Link>
